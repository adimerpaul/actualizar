...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="bg-success text-white text-center">Contribuyente duplicados</h1>
            </div>
            <div class="col-12">
                <form class="row g-3" id="formulario">
                    <div class="col-md-6">
                        <label for="ci" class="form-label">carnet</label>
                        <input type="text" class="form-control" id="comun" required>
                    </div>
                    <div class="col-md-6">
                        <label for="buscar" class="form-label">Buscar</label> <br>
                        <button class="btn btn-primary" id="buscar" type="submit" ><i class="fa fa-search"></i> Buscar</button>
                    </div>
                </form>
            </div>
            <div class="col-12">
        ...
        window.onload=function (){
            ...
            $("#contenido").on("click", ".limpiar", function(){
                ...
                if (confirm('Seguro de eliminar?')){
                    $.ajax({
                        url: "/duplicadocontribuyente/"+CodAut,
                        type:'DELETE',
                        data:{
                            "_token": "{{ csrf_token() }}",
                        },
            ...
            function mostrar(){
                $('#contenido').html('')
                $.ajax({
                    url: "/duplicadocontribuyente/"+$('#comun').val(),
                    success: function (res) {
                        ...
                        res.forEach(r=>{
                            t+='<tr>' +
                                ...
                                '<button  class=" limpiar btn btn-danger btn-sm" type="button" id-CodAut="'+r.Codauto+'" ><i class="fa fa-trash"></i> Eliminar</button>' +
                                '</div>'+
                                '</td>' +
                                '</tr>';
                        })
